              ...
              <tbody className='divide-y divide-border-light dark:divide-border-dark'>
                {mockTransactions.map((transaction) => (
                  <tr
                    ...
                    onClick={() =>
                      navigate(`/app/transactions/app/${transaction.id}`)
                    }
                  >
                    ...
                    <td className='px-6 py-4 whitespace-nowrap'>
                      ...
                      <p className='text-xs text-[#636f88]'>
                        {transaction.time}
                      </p>
                    </td>
                    <td className='px-6 py-4 whitespace-nowrap'>
                      <div className='flex items-center gap-2'>
                        <div className='bg-gray-100 rounded p-1'>
                          {getMerchantIcon(transaction.merchant.icon)}
                        </div>
                    ...
                    <td className='px-6 py-4 whitespace-nowrap'>
                      <div className='flex items-center gap-2'>
                        {getPaymentIcon(transaction.paymentMethod.type)}
                    ...
                    <td className='px-6 py-4 whitespace-nowrap align-middle'>
                      <div className='flex flex-col gap-1 w-full max-w-[160px]'>
                        <div className='flex justify-between items-center text-xs'>
                          {(() => {
                            const { textColor, text } = getRiskLevelStyles(
                              transaction.riskLevel as RiskLevel
                            );
                            return (
                              <>
                        ...
                        <div className='w-full h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden'>
                          <div
                            className={`h-full rounded-full ${
                              getRiskLevelStyles(transaction.riskLevel).bgColor
                            }`}
